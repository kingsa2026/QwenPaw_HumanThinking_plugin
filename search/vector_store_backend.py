...
class VectorStoreBackend:
    ...
    def _default_chroma_dir(self):
        """获取默认 Chroma 持久化目录"""
        import os
        return os.path.join(os.path.expanduser("~"), ".chroma")
    ...
    def _init_chroma(self):
        ...
        client_settings = Settings(
            ...
            persist_directory=self.connection_params.get("persist_directory") or self._default_chroma_dir(),
        )
