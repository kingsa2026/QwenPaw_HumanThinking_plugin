...
class TestSleepConfig:
    ...
    def test_default_config(self):
        """测试默认配置值"""
        from HumanThinking.core.sleep_manager import SleepConfig
...
class TestAgentSleepState:
    ...
    def test_initial_state(self):
        """测试初始状态"""
        from HumanThinking.core.sleep_manager import AgentSleepState
...
class TestGlobalFunctions:
    ...
    def test_init_sleep_manager(self):
        """测试初始化全局睡眠管理器"""
        from HumanThinking.core.sleep_manager import init_sleep_manager, SleepConfig, get_sleep_manager
    ...
    def test_get_sleep_manager_with_agent_id(self):
        """测试获取 Agent 专属睡眠管理器"""
        from HumanThinking.core.sleep_manager import (
    ...
    def test_get_sleep_manager_no_global(self):
        """测试无全局管理器时返回 None"""
        from HumanThinking.core.sleep_manager import get_sleep_manager
    ...
    def test_set_agent_sleep_config(self):
        """测试设置 Agent 睡眠配置"""
        from HumanThinking.core.sleep_manager import set_agent_sleep_config, get_agent_sleep_config, SleepConfig
    ...
    def test_save_agent_sleep_config_failure(self):
        """测试保存配置失败"""
        from HumanThinking.core.sleep_manager import save_agent_sleep_config, SleepConfig
    ...
    def test_pulse_agent(self):
        """测试心跳函数"""
        from HumanThinking.core.sleep_manager import init_sleep_manager, pulse_agent, SleepConfig
    ...
    def test_notify_task_start(self):
        """测试任务开始通知"""
        from HumanThinking.core.sleep_manager import init_sleep_manager, notify_task_start, SleepConfig
