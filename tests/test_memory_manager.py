...
class TestHumanThinkingConfig:
    ...
    def test_default_values(self):
        """测试默认配置值"""
        from HumanThinking.core.memory_manager import HumanThinkingConfig
...
class TestConfigManagement:
    ...
    def test_get_config_default(self):
        """测试获取默认配置"""
        from HumanThinking.core.memory_manager import get_config, HumanThinkingConfig
    ...
    def test_get_config_caching(self):
        """测试配置缓存"""
        from HumanThinking.core.memory_manager import get_config, _agent_configs
    ...
    def test_save_config(self, temp_dir):
        """测试保存配置"""
        from HumanThinking.core.memory_manager import save_config, HumanThinkingConfig
    ...
    def test_update_config(self):
        """测试更新配置"""
        from HumanThinking.core.memory_manager import update_config, get_config, _agent_configs
    ...
    def test_update_config_global(self):
        """测试更新全局配置"""
        from HumanThinking.core.memory_manager import update_config, get_config, _global_config
    ...
    def test_update_config_fields(self):
        """测试更新指定字段"""
        from HumanThinking.core.memory_manager import update_config_fields, get_config, _agent_configs
...
class TestMemoryResponse:
    ...
    def test_default_values(self):
        """测试默认值"""
        from HumanThinking.core.memory_manager import MemoryResponse
...
class TestContextLoadingInMemory:
    ...
    def test_init(self):
        """测试初始化"""
        from HumanThinking.core.memory_manager import ContextLoadingInMemory
...
class TestMemoryManagerInit:
    ...
    def test_init_required_params(self):
        """测试必需参数"""
        from HumanThinking.core.memory_manager import HumanThinkingMemoryManager
...
class TestMemoryManagerCore:
    ...
    async def test_emotional_engine_disabled(self, temp_dir):
        """测试禁用情感引擎"""
        from HumanThinking.core.memory_manager import HumanThinkingMemoryManager, get_config, update_config_fields
