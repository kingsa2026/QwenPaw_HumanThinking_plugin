...
class TestMemoryRecord:
    ...
    def test_default_tags(self):
        """测试默认标签为空列表"""
        from HumanThinking.core.database import MemoryRecord
...
class TestDatabaseInitialization:
    ...
    async def test_init_version(self, temp_db_path):
        """测试版本初始化"""
        from HumanThinking.core.database import HumanThinkingDB, CURRENT_SCHEMA_VERSION
        ...
        assert row[1] == CURRENT_SCHEMA_VERSION
