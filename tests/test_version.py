...
class TestVersionConstants:
    ...
    def test_current_version(self):
        """测试当前版本号格式正确"""
        from HumanThinking.utils.version import CURRENT_VERSION
    ...
    def test_current_schema_version(self):
        """测试当前 Schema 版本"""
        from HumanThinking.utils.version import CURRENT_SCHEMA_VERSION
    ...
    def test_min_compatible_version(self):
        """测试最低兼容版本"""
        from HumanThinking.utils.version import MIN_COMPATIBLE_VERSION
...
class TestIsCompatible:
    ...
    def test_current_version_compatibility(self):
        """测试当前版本兼容性"""
        from HumanThinking.utils.version import VersionManager, CURRENT_VERSION, MIN_COMPATIBLE_VERSION
...
class TestGetVersionInfo:
    ...
    def test_version_info_structure(self):
        """测试版本信息结构"""
        from HumanThinking.utils.version import VersionManager, CURRENT_VERSION, CURRENT_SCHEMA_VERSION, MIN_COMPATIBLE_VERSION
...
class TestNeedsMigration:
    ...
    def test_current_version_check(self):
        """测试当前版本检查"""
        from HumanThinking.utils.version import VersionManager, CURRENT_VERSION, CURRENT_SCHEMA_VERSION
